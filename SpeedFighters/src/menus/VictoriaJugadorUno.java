...
public class VictoriaJugadorUno extends JFrame implements ActionListener, MouseListener{

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;
	JButton btnSalir = new JButton("Salir");

	public VictoriaJugadorUno() {
		...
		btnSalir.setIcon(new ImageIcon(VictoriaJugadorUno.class.getResource("/Imagenes/SalirBoton.PNG")));
		
		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(VictoriaJugadorUno.class.getResource("/Imagenes/victoriaUno.png")));
		label.setBounds(0, 0, 1008, 536);
